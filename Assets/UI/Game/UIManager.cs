...
#region Variables
    [SerializeField]
    [Tooltip ("Store the refrence to the Kill Counter UI Element in here.")]
	private TextMeshProUGUI killCounter = null;

	[SerializeField]
    [Tooltip ("Store the Refrence to the Timer UI Element in here.")]
	private TextMeshProUGUI timer = null;

    [SerializeField]
    [Tooltip ("Store the Refrence to the Ammo UI here.")]
    private TextMeshProUGUI ammoDisplay = null;

	[SerializeField]
    [Tooltip ("Store the Refrence to the Slider UI Element in here.")]
	private Slider helicopterSlider = null;

    [SerializeField]
    [Tooltip ("Store the Refrence to the Health UI image here.")]
    private Image healthImage = null;

    [Space]

	[SerializeField]
    [Tooltip ("The Kill UI Pop Up prefab to instantiate when a zombie is killed.")]
    ...
    private void Start ()
    {
        ...
        gun = player.transform.GetComponentInChildren<Gun>();
